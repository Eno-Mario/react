...
function App() {
  const strongName= <strong>Mario</strong>
  return (
    <div>
      <Hello />
      ...
      <Welcome name={strongName} age={18} /> {/* Render the component Welcome to App component, passing it a name prop of your choosing. */}
